...
export default function PromotionsPage() {
  ...
  const getStatus = (promo: Promotion) => {
    ...
    if (now < from) return { label: "עתידי", className: "bg-orange-100 text-blue-800 border-blue-200" }
    if (now > until) return { label: "פג תוקף", className: "bg-red-100 text-red-800 border-red-200" }
    if (promo.maxUses && promo.currentUses >= promo.maxUses) return { label: "מלא", className: "bg-orange-100 text-blue-800 border-blue-200" }
