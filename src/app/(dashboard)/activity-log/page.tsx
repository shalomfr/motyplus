...
const ACTION_LABELS: Record<string, { label: string; color: string }> = {
  ...
  UPDATE: { label: "עדכון", color: "bg-orange-100 text-blue-800 border-blue-200" },
  DELETE: { label: "מחיקה", color: "bg-red-100 text-red-800 border-red-200" },
  SEND_EMAIL: { label: "שליחת מייל", color: "bg-orange-100 text-blue-800 border-blue-200" },
  SEND_UPDATE: { label: "שליחת עדכון", color: "bg-orange-100 text-blue-800 border-blue-200" },
